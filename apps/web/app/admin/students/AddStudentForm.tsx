...
export default function AddStudentForm({ programmes }: { programmes: { id: string; name: string }[] }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(false)
    if (error) { setError(error.message ?? 'Failed to create student'); return }
  ...
  return (
    <div className="card">
      <h2 className="text-lg font-display font-semibold text-brand-blue mb-4">Add Student</h2>
