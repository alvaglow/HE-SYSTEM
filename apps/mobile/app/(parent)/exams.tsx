/**
 * Mirrors apps/web/app/parent/exams (ParentExamsPage).
 */
...
export default function ParentExamsScreen() {
  ...
  const load = useCallback(async () => {
    ...
    const links = (linksRaw ?? []) as unknown as Array<{ students: { programme_id: string | null } | null }>
    ...
    const allExams = (examsRaw ?? []) as unknown as Exam[]
    setExams(allExams.filter(e => !e.programme_id || programmeIds.has(e.programme_id)))
    setLoading(false)
  }, [])
