...
const DEFAULT_TILES: QuickTile[] = [
  ...
  { key: '/(student)/booking', icon: '🏢', label: 'Room Booking', accent: colors.blue, route: '/(student)/booking' },
  { key: '/(student)/gpa-predictor', icon: '🔮', label: 'GPA Predictor', accent: colors.purple, route: '/(student)/gpa-predictor' },
  { key: '/(student)/graduation', icon: '🎓', label: 'Graduation', accent: colors.green, route: '/(student)/graduation' },
  { key: '/(student)/support', icon: '🛟', label: 'Support', accent: colors.amber, route: '/(student)/support' },
]
